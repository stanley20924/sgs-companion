...
const changelog = [
  {
    ...
    date: "2026/07/11",
    title: "選將建議工具",
    summary: "新增牌局內 AI 選將建議截圖工具，支援國戰雙將組合與身分局單將身份評估。",
    sections: [
      {
        heading: "國戰選將",
        items: ["新增國戰選將建議入口，可從目前牌局模式與版本搜尋候選武將。", "支援最多 7 張候選武將，並自動列出合法同勢力配對。", "雙勢力武將會納入同勢力判斷，避免推薦不合法組合。"]
      },
      {
        heading: "身分局選將",
        items: ["新增身分局選將建議模式，可選擇主公、忠臣、反賊、內奸。", "身分局 prompt 會依玩家身份要求 AI 推薦最適合的單將。", "切換玩法模式或版本時會自動清空候選，避免不同版本武將混用。"]
      },
      {
        heading: "AI 截圖流程",
        items: ["產生手機截圖友善的 AI 分析卡，保留完整武將牌面供 AI 讀取技能。", "加入一鍵複製 prompt。", "加入 ChatGPT、Gemini、Claude、DeepSeek 開啟入口。"]
      }
    ]
  },
  {
